# AAEC Telemetry Projections: Flagship & Future MoE Models

Based on the physical hardware telemetry measured on our NVIDIA H100 node, we formulate mathematical systems projections for running today's flagship MoE architectures under VRAM constraints using the **AAEC (Active-Neuron Activation-guided Expert Caching)** paradigm.
...
### AAEC Caching & Transfer Projections:
...
2.  **AAEC Neuron Channel Transfer:**
...
### Cross-Model AAEC Projections Summary Table

| Model Target | Precision | Active Experts | Wire Payload Red. | PCIe Transfer (Base vs AAEC) | Projected PCIe Speedup | Projected NVL Speedup |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
